  ...
  render() {
    ...
    return (
      <div id="errors-customization">
        <h4>6. Errors customization <a href="#errors-customization" className="anchor" aria-label="anchor" aria-hidden="true">#</a></h4>
        <div className="row">
          <div className="col-6">
            <Form
              validation={() => ({
            ...
            >
              ...
              <Text type="text" id="e6_email" name="email" hideError={true} />
              <strong><FieldError name="email" /></strong>

              <label htmlFor="e6_firstName">First Name</label>
              <Text type="text" id="e6_firstName" name="profile.firstName" hideError={true} />
              <FieldError name="profile.firstName" className="add-some-error-class" />
