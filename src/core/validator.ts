...
const Required =
  (message = 'Required'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return message;
    }
...
const MinLength =
  (min: number, message = `Minimum ${min} characters`): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const MaxLength =
  (max: number, message = `Maximum ${max} characters`): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Numeric =
  (message = 'Not valid number'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const IntegerNumber =
  (message = 'Not valid integer number'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const FloatNumber =
  (message = 'Not valid float number'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Min =
  (min: number, message = `Minimum ${min}`): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Max =
  (max: number, message = `Maximum ${max}`): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Range =
  (range: Array<any>, message = 'Not valid'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Email =
  (message = 'Not valid email address'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
...
const Preg =
  (regexp: RegExp, message = 'Not valid'): ValidatorInterface =>
  (value: ValueType) => {
    if (isEmpty(value)) {
      return true;
    }
